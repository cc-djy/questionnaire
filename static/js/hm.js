(function() {
    var h = {},
        mt = {},
        c = { id: "21be24c80829bd7a683b2c536fcf520b", dm: ["wjx.cn"], js: "tongji.baidu.com/hm-web/js/", etrk: [], icon: '', ctrk: false, align: -1, nv: -1, vdur: 1800000, age: 31536000000, rec: 0, rp: [], trust: 0, vcard: 0, qiao: 0, lxb: 0, conv: 0, med: 0, cvcc: '', cvcf: [], apps: '' };
    var q = void 0,
        r = !0,
        t = null,
        u = !1;
    ...
    mt.cookie.get = function(a) { return (a = RegExp("(^| )" + a + "=([^;]*)(;|$)").exec(document.cookie)) ? a[2] : t };
    mt.h = {};
    mt.h.oa = function(a) { return document.getElementById(a) };
    mt.h.J = function(a, b) {
        var d = [],
            f = [];
        if (!a) return f;
        for (; a.parentNode != t;) {
            for (var g = 0, n = 0, l = a.parentNode.childNodes.length, p = 0; p < l; p++) { var e = a.parentNode.childNodes[p]; if (e.nodeName === a.nodeName && (g++, e === a && (n = g), 0 < n && 1 < g)) break }
            if ((l = "" !== a.id) && b) { d.unshift("#" + encodeURIComponent(a.id)); break } else l && (l = "#" + encodeURIComponent(a.id), l = 0 < d.length ? l + ">" + d.join(">") : l, f.push(l)), d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < g ? "[" + n + "]" : ""));
            a = a.parentNode
        }
        f.push(d.join(">"));
        return f
    };
    mt.h.$a = function(a) { return (a = mt.h.J(a, r)) && a.length ? String(a[0]) : "" };
    mt.h.Za = function(a) { return mt.h.J(a, u) };
    ...
    mt.h.pa = function(a) { return 9 === a.nodeType ? a : a.ownerDocument || a.document };
    ...
    (mt.h.Ea = function() {
        function a() { if (!a.A) { a.A = r; for (var b = 0, d = f.length; b < d; b++) f[b]() } }

        function b() {
            try { document.documentElement.doScroll("left") } catch (d) { setTimeout(b, 1); return }
            a()
        }
        var d = u,
            f = [],
        ...
        document.addEventListener ? g = function() {
            ...
            a()
        } : document.attachEvent && (g = function() { "complete" === document.readyState && (document.detachEvent("onreadystatechange", g), a()) });
        (function() {
            if (!d)
                ...
                var f = u;
                try { f = window.frameElement == t } catch (l) {}
                document.documentElement.doScroll && f && b()
            }
        })();
        return function(b) { a.A ? b() : f.push(b) }
    }()).A = u;
    mt.event = {};
    mt.event.c = function(a, b, d) { a.attachEvent ? a.attachEvent("on" + b, function(b) { d.call(a, b) }) : a.addEventListener && a.addEventListener(b, d, u) };
    ...
    (function() {
        ...
        mt.f.L = function() { var a = document; return parseInt(window.innerHeight || a.documentElement.clientHeight || a.body && a.body.clientHeight || 0, 10) };
        mt.f.orientation = 0;
        (function() {
            function b() {
                var a = 0;
    ...
    mt.l = {};
    mt.l.parse = function() { return (new Function('return (" + source + ")'))() };
    ...
    mt.lang.cb = function(a) { return mt.lang.d(a, "Number") && isFinite(a) };
    mt.lang.fb = function(a) { return mt.lang.d(a, "String") };
    mt.lang.j = function(a) { return a.replace ? a.replace(/'/g, "'0").replace(/\*/g, "'1").replace(/!/g, "'2") : a };
    mt.localStorage = {};
    mt.localStorage.C = function() {
        if (!mt.localStorage.g) try { mt.localStorage.g = document.createElement("input"), mt.localStorage.g.type = "hidden", mt.localStorage.g.style.display = "none", mt.localStorage.g.addBehavior("#default#userData"), document.getElementsByTagName("head")[0].appendChild(mt.localStorage.g) } catch (a) { return u }
        return r
    };
    mt.localStorage.set = function(a, b, d) {
        var f = new Date;
        f.setTime(f.getTime() + d || 31536E6);
        try { window.localStorage ? (b = f.getTime() + "|" + b, window.localStorage.setItem(a, b)) : mt.localStorage.C() && (mt.localStorage.g.expires = f.toUTCString(), mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.setAttribute(a, b), mt.localStorage.g.save(document.location.hostname)) } catch (g) {}
    };
    mt.localStorage.get = function(a) {
        ...
        } else if (mt.localStorage.C()) try { return mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.getAttribute(a) } catch (f) {}
        return t
    };
    mt.localStorage.remove = function(a) {
        if (window.localStorage) window.localStorage.removeItem(a);
        else if (mt.localStorage.C()) try { mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.removeAttribute(a), mt.localStorage.g.save(document.location.hostname) } catch (b) {}
    };
    mt.sessionStorage = {};
    mt.sessionStorage.set = function(a, b) { if (window.sessionStorage) try { window.sessionStorage.setItem(a, b) } catch (d) {} };
    mt.sessionStorage.get = function(a) { return window.sessionStorage ? window.sessionStorage.getItem(a) : t };
    ...
    mt.S.ua = function() {
        ...
        } else if (window.ActiveXObject) try { if (b = new ActiveXObject("ShockwaveFlash.ShockwaveFlash"))(a = b.GetVariable("$version")) && (a = a.replace(/^.*\s+(\d+),(\d+).*$/, "$1.$2")) } catch (d) {}
        return a
    };
    ...
    mt.url = {};
    mt.url.i = function(a, b) { var d = a.match(RegExp("(^|&|\\?|#)(" + b + ")=([^&#]*)(&|$|#)", "")); return d ? d[3] : t };
    mt.url.ab = function(a) { return (a = a.match(/^(https?:)\/\//)) ? a[1] : t };
    mt.url.ra = function(a) { return (a = a.match(/^(https?:\/\/)?([^\/\?#]*)/)) ? a[2].replace(/.*@/, "") : t };
    mt.url.W = function(a) { return (a = mt.url.ra(a)) ? a.replace(/:\d+$/, "") : a };
    mt.url.J = function(a) { return (a = a.match(/^(https?:\/\/)?[^\/]*(.*)/)) ? a[2].replace(/[\?#].*/, "").replace(/^$/, "/") : t };
    (function() {
        function a() { for (var a = u, d = document.getElementsByTagName("script"), f = d.length, f = 100 < f ? 100 : f, g = 0; g < f; g++) { var n = d[g].src; if (n && 0 === n.indexOf("https://hm.baidu.com/h")) { a = r; break } } return a }
        return h.na = a
    })();
    var A = h.na;
    ...
    (function() {
        var a = {
            ...
            w: function(a, d) { this.p[a] = this.p[a] || []; for (var f = this.p[a].length, g = 0; g < f; g++) this.p[a][g](d) }
        };
        return h.G = a
    })();
    (function() {
        function a(a, f) {
            ...
            g.charset = "utf-8";
            b.d(f, "Function") && (g.readyState ? g.onreadystatechange = function() { if ("loaded" === g.readyState || "complete" === g.readyState) g.onreadystatechange = t, f() } : g.onload = function() { f() });
            g.src = a;
    ...
    (function() {
        ...
        function f(a) { if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) k = "focus" == a.type || "focusin" == a.type ? r : u, b() }
        var g = mt.event,
            n = h.G,
            l = r,
            p = r,
        ...
        h.F = { sa: function() { return +new Date - w }, qa: function() { return y ? +new Date - m + s : s } };
        n.c("pv-b", function() { g.c(window, "unload", a()) });
        return h.F
    })();
    (function() {
        var a = mt.lang,
            ...
            f = {
                ...
                Ma: function(d) { if (a.d(d, "String") || a.d(d, "Number")) window._dxt = window._dxt || [], window._dxt.push(["_setUserId", d]) }
            };
        return h.ha = f
    })();
    (function() {
        ...
        var d = mt.lang,
            ...
            e = {
                ...
                _setAccount: function(a) { 1 < a.length && /^[0-9a-f]{32}$/.test(a[1]) && (e.e |= 1) },
                _setAutoPageview: function(a) { if (1 < a.length && (a = a[1], u === a || r === a)) e.e |= 2, h.b.X = a },
                ...
                _trackMobConv: function(a) { if (a = { webim: 1, tel: 2, map: 3, sms: 4, callback: 5, share: 6 }[a[1]]) e.e |= 32, h.b.a.et = 93, h.b.a.ep = a, h.b.k() },
    ...
    (function() {
        function a() { "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = r, this.a = {}, this.X = r, this.M = u, this.init()) }
        var b = mt.url,
            d = mt.aa,
            f = mt.S,
            g = mt.lang,
        ...
        a.prototype = {
            ...
            Z: function(a, b) { a = a.replace(/^https?:\/\//, ""); return 0 === a.indexOf(b) },
            z: function(a) {
                for (var d = 0; d < c.dm.length; d++)
                    if (-1 <
                        c.dm[d].indexOf("/")) { if (this.Z(a, c.dm[d])) return r } else { var e = b.W(a); if (e && this.N(e, c.dm[d])) return r }
                return u
            },
            I: function() {
            ...
            V: function() { for (var a = 0, b = c.dm.length; a < b; a++) { var d = c.dm[a]; if (-1 < d.indexOf("/") && this.Z(document.location.href, d)) return d.replace(/^[^\/]+(\/.*)/, "$1") + "/" } return "/" },
            ta: function() {
            ...
            getData: function(a) { try { return n.get(a) || e.get(a) || p.get(a) } catch (b) {} },
            setData: function(a, b, d) { try { n.set(a, b, { domain: this.I(), path: this.V(), H: d }), d ? p.set(a, b, d) : e.set(a, b) } catch (f) {} },
            Fa: function(a) { try { n.set(a, "", { domain: this.I(), path: this.V(), H: -1 }), e.remove(a), p.remove(a) } catch (b) {} },
            Ka: function() {
                var a, b, d, e, f;
            ...
            init: function() {
                try { this.La(), 0 === this.a.nv ? this.Ia() : this.R(".*"), h.b = this, this.ga(), w.w("pv-b"), this.Ha() } catch (a) {
                    var b = [];
                    b.push("si=" + c.id);
            ...
            Ia: function() {
                ...
                if (b)
                    for (var b = b.split(","), f = function(b) { d.log(k.O + "//" + decodeURIComponent(b), function(b) { a.R(b) }) }, g = 0, l = b.length; g < l; g++) f(b[g])
            }
        };
        return new a
    })();
    (function() {
        ...
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                a.c(window, "load", function() { setTimeout(f, 500) })
            }
        } catch (g) {}
    })();
    (function() {
        ...
        if ("undefined" !== typeof h.b && (c.med || (!a.Da || 7 < a.Ba) && c.cvcc)) {
            var g, n, l, p, e = function(a) { if (a.item) { for (var b = a.length, d = Array(b); b--;) d[b] = a[b]; return d } return [].slice.call(a) },
                k = function(a, b) {
                    for (var d in a)
            ...
            if ("undefined" !== typeof p && "undefined" !== typeof l) {
                ...
                d.c(document, "mousedown", function(a) {
                    ...
                    var d = {};
                    for (k(p, function(a, e) { d[a] = b.d(e, "Function") ? e() : document.getElementById(e) }); s &&
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.b && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var g = {
                ca: function() { for (var b = c.cvcf.length, f, p = 0; p < b; p++)(f = a.oa(decodeURIComponent(c.cvcf[p]))) && d.c(f, "click", g.ka()) },
                ka: function() {
                    return function() {
                        h.b.a.et = 86;
                        var a = { n: "form", t: "clk" };
